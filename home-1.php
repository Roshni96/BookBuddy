...
<br/>
		<form align="center" action="add.php" method="POST" style="color:white;">
			...
			<input type="submit" align="center" value="Add to the list" style="color:#D5DDE5;
  background:#1b1e24;
  border-bottom:4px solid #9ea7af;
  border-right: 1px solid #343a45;
  font-size:23px;
  font-weight: 100;margin-left:25%;height:30px;color:white;width:50%;text-align:center;padding: 30px 30px 30px 30px;
  text-shadow: 0 1px 1px rgba(0, 0, 0, 0.1);margin-left:25%;height:30px;color:white;background-color:black;width:50%;text-align:center"/>
		</form>
<br/>
<br/>
		...
		<form align="center" action="delete.php" method="POST" style="color:white;">
			...
			<input type="submit" align="center" value="Delete" style="color:#D5DDE5;
  background:#1b1e24;
  border-bottom:4px solid #9ea7af;
  border-right: 1px solid #343a45;
  font-size:23px;
